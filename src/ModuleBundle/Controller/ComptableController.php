...
class ComptableController extends Controller
{
    function ficheAnnoncesAction(Request $request)
    {
        ...
        return $this->render('@User/template/fiche/Comptable/annonces.html.twig', [
    ...
    public function ficheServicesAction(Request $request)
    {
        ...
        return $this->render('@User/template/fiche/Comptable/services.html.twig', [
            'attributes' => $request->attributes->all(),
            'service' => $data,
    ...
    function appelAddAction(Request $request)
    {
        $message = (new \Swift_Message('Reservation'))
            ...
            ->setBody($this->renderView('@User/template/fiche/Comptable/email.html.twig', array(
                'name' => $request->get('nom'),
                'time' => $request->get('time'),
                'date'=>$request->get('date'),
                'email' =>$request->get('email'),
                'tel' => $request->get('tel'))), 'text/html');
