...
//            dump($request->get('TypeGallery'),$img,$chars);
    ...
    function addServiceGlobalAction($themeId, $quoiquiId)
    {
      ...
      */
            ...
            if (!is_dir($this->get('app.image_uploader')->targetDir . "/$idUser" . "/$quoiquiId")):
                mkdir($this->get('app.image_uploader')->targetDir . "/$idUser" . "/$quoiquiId");
            endif;

            if (!is_dir($this->get('app.image_uploader')->targetDir . "/$idUser" . "/$quoiquiId" . "/service")):
                mkdir($this->get('app.image_uploader')->targetDir . "/$idUser" . "/$quoiquiId" . "/service", 0777);
                chmod($this->get('app.image_uploader')->targetDir . "/$idUser" . "/$quoiquiId" . "/service", 0777);
            endif;
            $this->uploadFiles($_FILES, $this->get('app.image_uploader')->targetDir . "/$idUser/$quoiquiId/service/", $idService);
        }
