        ...
        $message->setFrom('noreply@ween.tn')
            ...
            ->setBody(
                $this->renderView('@Module/mail/location-reserver-voiture-mail.html.twig', array(
                    ...
                    'body' => "Demande de reservation  voiture :" . $request->request->get("mark") . ' ' . $request->request->get("model") . ' ' . $request->request->get("mark"),
                    'subject' => 'Demande de reservation: ' . $request->request->get("mark") . ' ' . $request->request->get("model") . ' ' . $request->request->get("mark"),
                )), "text/html");
        $mailer->send($message);
