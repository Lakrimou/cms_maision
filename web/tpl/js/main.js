    ...
    if (loc == 'yes') {
        if (jQuery('.form-group').is('.lp-location-search')) {
            if (apiType === "geo_ip_db") {
                ...
                jQuery.get("http://ip-api.com/json", function (location) {
                    jQuery("#searchlocation").prop('disabled', true).trigger('chosen:updated');
                    jQuery('#searchlocation').find('#def_location').text(location.city);
                    jQuery('#searchlocation').find('#def_location').val(location.city);
                    jQuery(".select2-selection__rendered").attr("title", location.city).text(location.city);
...
jQuery(document).ready(function () {
    ...
    jQuery('a.grid').on('click', function (event) {
        ...
        jQuery('.post-with-map-container').find('.lp-grid-box-contianer.card1.lp-grid-box-contianer1').addClass('col-md-4 col-sm-6 grid_view2');
    ...
    jQuery('a.list').on('click', function (event) {
        ...
        // Listing with Map
        jQuery('.post-with-map-container').find('.lp-grid-box-contianer.card1.lp-grid-box-contianer1').removeClass('col-md-4 col-sm-6 grid_view2');
        jQuery('.post-with-map-container').find('.lp-grid-box-contianer.card1.lp-grid-box-contianer1').addClass('col-sm-12 list_view');

        // Listing Simple
        jQuery('.listing-simple').find('.lp-grid-box-contianer.card1.lp-grid-box-contianer1').removeClass('col-md-4 col-sm-12 grid_view2');
...
//============================================ Harry Code ==================================================//
    ...
    if (jQuery('fiche').is('.single-listing')) {
        if (jQuery(window).width() >= 768) {
    ...
    if (jQuery('fiche').is('.single-listing')) {
        ...
        // jQuery(".listing-slide").not('.slick-initialized').slick();
 ...
 */
        ...
        if (jQuery('#map').is('.mapSidebar')) {
            ...
            if ($mtoken != '') {
                ...
                L.tileLayer('https://api.tiles.mapbox.com/v4/' + $mapboxDesign + '/{z}/{x}/{y}.png?access_token=' + $mtoken + '', {
                    maxZoom: 18,
                    attribution: 'Map data &copy; <a href="https://webmaster-media.tn">Webmaster Media</a> contributors, ' +
                    '<a href="https://webmaster-media.tn">Webmaster Media</a>, ' +
                    'Imagery Â© <a href="https://webmaster-media.tn">Webmaster Media</a>',
                    id: 'mapbox.light'
                }).addTo(map);
    ...
    jQuery(document).on('click', '.qickpopup', function () {
        ...
        if (jQuery('#modal-' + LPpostID).is('.md-show')) {

        } else {
            jQuery('#modal-' + LPpostID).modal({
                show: 'true'
            });
            jQuery('#modal-' + LPpostID).addClass('md-show');
        }
